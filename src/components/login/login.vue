    ...
    <div class="box">
        ...
        <div class="login">
            <div class="header">
                ...
                <span class="register-btn" @click="geRegister()">注册</span>
            </div>
            <div class="logo">
            ...
            <div class="content">
                ...
                <div class="user">
                    ...
                    <input :type="inputType" v-model="password" placeholder="请填写登录密码"/>
                    <img :src="imgChange?imgOne:imgTwo" @click="change()"/>
                    <span class="forget_btn" @click="goReset()">忘记密码?</span>
                </div>
            </div>
    ...
    export default {
        ...
        methods:{
            ...
            loginBtn(){
                ...
                getResult('post',`https://www.apiopen.top/login?key=00d91e8e0cca2b76f515926a36db68f5&phone=${this.phone}&passwd=${this.password}`)
                    .then(data=>{
                        console.log(data)
                        if(data.code == 200){
                            console.log('成功')
